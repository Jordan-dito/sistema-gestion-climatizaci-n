...
<!--<body background="../public/images/img_login/dos-montones-arroz-blanco.jpg">-->

<!--<body background="../public/images/img_login/O arroz que foi descascado é colocado com arroz em branco_ _ Foto Grátis.jpg">-->
<body background="../public/images/img_login/frios.jpg">

<!--<body background="../public/images/img_login/cerca-arroz-mixto.jpg">-->
...
<div class="login-box">
    ...
    <center>
  <!--<img src="../public/images/img_login/WhatsApp Image 2023-11-02 at 09.52.44.jpeg" alt="" width="300px">-->
  <img src="../public/images/img_login/frios_2.jpg" alt="" width="300px">
  </center>
  <br>
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="../public/templeates/AdminLTE-3.2.0/index2.html" class="h1"><b>Sistema</b> Hermanos "Frios"</a>
        </div>
        <div class="card-body">
    ...
    <div class="input-group mb-3">
        <input type="password" name="password_user" class="form-control" placeholder="Password" id="password">
        <div class="input-group-append">
...
<div class="row mt-2">
    <div class="col-12 text-center">
        <a href="./reset.php" class="btn btn-link">¿Olvidaste tu contraseña?</a>
    </div>
</div>
