...
$sql_compras = "SELECT *, co.precio_compra as precio_compra, 
                ...
                prov.email as email_proveedor,prov.direccion as direccion_proveedor, us.nombres as nombres_usuario 
...
foreach ($compras_datos as $compras_dato){
    ...
    $iva = $compras_dato['iva'];
    $precio_total = $compras_dato['precio_total'];
