                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <!--<td>
                                                    /*<center>< echo $carrito_dato['precio_venta']; ?></center></td>-->
                                                ...
                                                <td>
                                                    <center>
                                                        ...
                                                        $precio_total_iva = $precio_total + $precio_iva;
                                                        ?>-->
                                                        <?php echo number_format($subtotal, 2); ?></center>
                                        ...
                                        <tr>
                                            ...
                                            <th style="background-color: #fff2cc;">
                                                <center><?php echo  number_format($precio_total, 2);?></center>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th style="background-color: #FFA07A;">
                                                <center><?php echo number_format($precio_iva, 2); ?></center>
                                            </th>
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="total_a_cancelar" style="text-align:center; background-color:#fff819" value="<?php echo number_format($precio_total_iva, 2); ?>" disabled>
