...
// Consulta para obtener todos los datos de ventas y clientes
...
<div class="content-wrapper">
    ...
    <div id="resultContainer"></div> <!-- Contenedor para mostrar los resultados -->
</div>
...
document.getElementById('applyFilter').addEventListener('click', function() {
    ...
    fetch('../app/controllers/ventas/listado_de_ventas.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json()) // Asegúrate de que el PHP retorne un JSON
    .then(data => {
        ...
        data.forEach(venta => {
            resultContainer.innerHTML += `
                <div>
                    ...
                    <p>Número de Venta: ${venta.nro_venta}</p>
                    <p>ID Cliente: ${venta.id_cliente}</p>
                    <p>Total Pagado: ${venta.total_pagado}</p>
                    <p>Fecha y Hora de Creación: ${venta.fyh_creacion}</p>
                    <p>Nombre Cliente: ${venta.nombre_cliente}</p>
                    <p>NIT/CI Cliente: ${venta.nit_ci_cliente}</p>
                    <p>Celular Cliente: ${venta.celular_cliente}</p>
                    <p>Email Cliente: ${venta.email_cliente}</p>
                    <hr>
                </div>
            `;
        });
